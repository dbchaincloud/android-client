...
public class LogInterceptor implements Interceptor {
    ...
    private boolean isString(MediaType mediaType) {
        ...
        return TextUtils.equals(subtype, "json")
                || TextUtils.equals(subtype, "xml")
                || TextUtils.equals(subtype, "html")
                || TextUtils.equals(subtype, "text")
                || TextUtils.equals(subtype, "webviewhtml");
    }
